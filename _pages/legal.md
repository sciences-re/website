...
En utilisant ces services, vous reconnaissez être lié par les présentes conditions.
...
Nous nous efforcerons, dans la mesure du raisonnable de vous le notifier à l’adresse e-mail associée à votre compte ou lors de votre prochaine tentative de connexion à votre compte.
### Accès à vos données, rectification, suppression…

Vous pouvez demander une archive de votre contenu, incluant vos posts, vos médias joints, votre image de profil et votre image d’en-tête, de manière autonome, à l'adresse [https://social.sciences.re/settings/export](https://social.sciences.re/settings/export).

Concernant les données conservées en sus du fait de nos obligations légales, il est nécessaire de nous contacter à l'adresse email [dpo@sciences.re](mailto:dpo@sciences.re). Une preuve de contrôle du compte concerné sera demandée.
...
- Nous ne partagerons pas d'informations vous concernant avec des services tiers, sauf pour la fourniture du service et dans les conditions spécifiées dans le [registre des activités de traitement](/ropa-mastodon/) ;
...
- Si un membre de la communauté ne respecte pas ce code, veuillez le signaler à l'équipe de modération, même si vous ne faites pas partie des parties directement concernées. L'équipe pourra alors prendre les mesures qu'elle jugera nécessaire pour protéger la communauté. Les infractions répétées au code peuvent entraîner une expulsion temporaire ou la fin du contrat.
...
Ce document a été mis à jour pour la dernière fois le {{ page.last_modified_at | date : "%d/%m/%Y à %H:%M" }}.
