 ...
 * AGPLv3 -- Mastodon embed feed timeline Copyright (C) 2021  i.j
*/
...
window.addEventListener("load", () => {
  const mastodonTimeline = new MastodonApi({
    ...
    instance_url: "https://social.sciences.re",

    // Choose type of toots to show in the timeline: 'local', 'profile', 'hashtag'. Default: local
    timeline_type: urlParams.get('timeline_type'),
...
const MastodonApi = function (params_) {
  ...
  this.TOOTS_LIMIT = ((typeof params_.toots_limit !== "undefined") && params_.toots_limit !== null) ? params_.toots_limit : "20";
  this.HIDE_UNLISTED =
    ((typeof params_.hide_unlisted !== "undefined") && params_.hide_unlisted !== null)
